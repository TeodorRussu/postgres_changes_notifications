...
"""
pgnotify_wrapper.api
~~~~~~~~
Class definitions to be able to create an initial pgnotify_wrapper object.
...
import time
import json
from pgnotify_wrapper import utils

log = logging.getLogger(__name__)


class PgNotify(object):
    """Class to create a pgnotify_wrapper object"""
    ...
    def listen(self, callback):
        self.curs.execute("LISTEN pgnotify_wrapper;")
        while True:
